...
if __name__ == "__main__":
    ...
    download_dir = Path(os.path.join('F:\\usr\\local\\LAVIS-main\\lavis\\datasets\\download_scripts\\downloaded', storage_dir)).parent / "download"
    storage_dir = Path(os.path.join('F:\\usr\\local\\LAVIS-main\\lavis\\datasets\\download_scripts\\downloaded', storage_dir))
