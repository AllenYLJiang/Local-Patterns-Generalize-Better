        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            for itern, data_arr in enumerate(pbar):
                try:
                    ...
                    label = data[-1] # 256 的 float 64 1 ---> 正常数据 都是1 
                    ...
                    # ######################################
                    z, nll = self.model(samp.float(), label=label, score=score) # sample 256 2 24 18   nll 256 
                    if nll is None:
                        continue
            ...
            self.save_checkpoint(epoch, filename=epoch+ "_" +checkpoint_filename)
