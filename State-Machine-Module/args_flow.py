...
def init_parser(default_data_dir='data/', default_exp_dir='data/exp_dir_flow_train'):
    ...
    parser.add_argument('--checkpoint', type=str,
                        ...
                        default= "data\exp_dir_flow_train\ShanghaiTech\Jul10_1024\ep0_Jul10_1025__checkpoint.pth.tar",
                        # default = None,
