...
def init_model_params(args, dataset):
    return {
        'pose_shape': dataset["test"][0][0].shape if args.model_confidence else dataset["test"][0][0][:2].shape, # pose.shape 2 18 2 or 3
        # 'pose_shape': (2,224,224), # pose.shape 2 18 2 or 3
        # 'pose_shape': (24, 2, 18),  # pose.shape 2 18 2 or 3
