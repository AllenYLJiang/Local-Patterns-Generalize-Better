...
def main():
    ...
    if args.smooth_or_predwithsmoothed_or_predwithunsmoothed == 'smooth':
        args.checkpoint = "/root/Downloads/STG-NF/data/exp_dir_state/ShanghaiTech/trained_on_test_90_epochs_set_20_pred_4/89_ep_Jul23_1405__checkpoint.pth.tar"
        args.global_pose_segs = True # normalize coords
    elif args.smooth_or_predwithsmoothed_or_predwithunsmoothed == 'predwithunsmoothed':
        args.checkpoint = "/root/Downloads/STG-NF/data/exp_dir_state/ShanghaiTech/20_pred_4_with_displacement/14_ep_Jul14_2029__checkpoint.pth.tar"#"/root/Downloads/STG-NF/data/exp_dir_state/ShanghaiTech/20_pred_4_with_displacement/14_ep_Jul14_2029__checkpoint.pth.tar"
        args.global_pose_segs = True # normalize coords
    elif args.smooth_or_predwithsmoothed_or_predwithunsmoothed == 'predwithsmoothed':
        args.checkpoint = "/root/Downloads/STG-NF/data/exp_dir_state/ShanghaiTech/20_pred_4_with_displacement/14_ep_Jul14_2029__checkpoint.pth.tar"#"/root/Downloads/STG-NF/data/exp_dir_state/ShanghaiTech/20_pred_4_with_displacement/14_ep_Jul14_2029__checkpoint.pth.tar"
        args.global_pose_segs = False # normalize coords
    ...
    if args.smooth_or_predwithsmoothed_or_predwithunsmoothed == 'smooth':
        ...
        for input_file in [x for x in os.listdir('data/ShanghaiTech/pose/test') if '_tracked_person' in x]:#[105:]:
            ...
            trainer.smooth_pose_sequences_with_state_machine(os.path.join('data/ShanghaiTech/pose/test', input_file), \
                                                             os.path.join('data/ShanghaiTech/pose/test_state_machine_refined', input_file), 24, input_frame, conf_gain_thresh)
        return
