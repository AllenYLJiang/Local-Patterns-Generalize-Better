...
def init_parser(default_data_dir='data/', default_exp_dir='data/exp_dir_state/'):
    ...
    parser.add_argument('--seg_len', type=int, default=5, metavar='SGLEN', help='Number of frames for training segment sliding window, a multiply of 6 (default: 12)')
    ...
    parser.add_argument('--checkpoint', type=str,
                        ...
                        default="/root/Downloads/STG-NF/data/exp_dir_state/ShanghaiTech/20_pred_4_with_displacement/14_ep_Jul14_2029__checkpoint.pth.tar",#"/root/Downloads/STG-NF/data/exp_dir_state/ShanghaiTech/Jul13_2209/4_ep_Jul13_2211__checkpoint.pth.tar",#"/root/Downloads/STG-NF/data/exp_dir_state/ShanghaiTech/Jul10_2128_frame20_dmodel64/0_Jul10_2130__checkpoint.pth.tar",
                        # default = None,
